...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(false);
      console.error(error);
      setAlert("Error signing up. Please try again.");
    }
  };
          ...
          <div className="bg-white/20 backdrop-blur-lg rounded-3xl p-10 border border-white/30 shadow-2xl w-full max-w-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-medium py-3 px-6 rounded-xl transition-transform duration-300 transform hover:scale-105 shadow-lg cursor-pointer"
              >
            ...
            <div className="text-center mt-6">
              <span className="text-white/70 text-sm">
                ...
                <Link to="/sign-in" className="text-blue-300 hover:text-blue-400 underline cursor-pointer">
                  Signin
                </Link>
              </span>
            </div>
